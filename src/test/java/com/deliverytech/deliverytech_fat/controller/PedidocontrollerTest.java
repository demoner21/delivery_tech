 ...
 *  - Restaurante deve estar ATIVO e ter taxaEntrega definida
 *  - Produto deve estar DISPONÍVEL e pertencer ao mesmo restaurante do pedido
 *
 * @Transactional garante rollback após cada teste (banco sempre limpo).
 */
@SpringBootTest
